        ...
        return (
            <div className="HelpView">
                ...
                <div id="mainContent">
                    ...
                    <h2 id="NavigatorAndDisplayTools">Navigator and Display Tools</h2>
                    <img src={require("./images/navigatorhome.png")} alt="Navigator and Display Tools"/>
                    <p>
                    ...
                    <img src={require("./images/Intro_2.jpg")} alt="Navigator and Display Tools 2" />
                    <p>
                    ...
                    <img src={require("./images/Intro_3.jpg")} alt="Navigator and Display Tools 3" />
                    <p>
                    ...
                    <img src={require("./images/Intro_4.jpg")} alt="Timeline" />
                    <p>
                    ...
                    <img src={require("./images/Intro_5.jpg")} alt="Timeline 2" />
                    <p>
                        You can click on the date fields and use the red dot to drag the dates around.
                    </p>
                    <h2 id="MiniUserNexusandMapTools">Mini User Nexus and Map Tools</h2>
                    <img src={require("./images/Intro_mini-user-nexus_map.jpg")} alt="User Nexus and Map Tools" />
                    <p>
                    ...
                    <h2 id="Nexus Graph">Nexus Graph</h2>
                    <img src={require("./images/Intro_Nexus_1.jpg")} />
                    <p>
                    ...
                    <img src={require("./images/Intro_Nexus_2.jpg")} />
                    <p>
                    ...
                    <h1 id="StoryPersonView">Story View and Person View</h1>
                    <h2>Story View</h2>
                    ...
                    <h1 id="PlaceFieldtripViews">Place View and Fieldtrip View</h1>
                    ...
                    <h2 id="NexusGraph">Nexus Graph</h2>
                    <p>
                    ...
                    <h2 id="SearchFeatures">Search Features</h2>
                    <p>
